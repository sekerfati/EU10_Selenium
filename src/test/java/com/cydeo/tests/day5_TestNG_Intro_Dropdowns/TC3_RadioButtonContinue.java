...
public class TC3_RadioButtonContinue {
...
clickVerifyRadioButton(driver, "sport", "football");
clickVerifyRadioButton(driver, "color", "yellow");
  ...
  private static void clickVerifyRadioButton(WebDriver driver, String nameAttribute, String idValue){
